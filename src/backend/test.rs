...
"#,
    ...
    fn assert_buffer() {
        let backend = TestBackend::new(10, 2);
        let buffer = Buffer::with_lines(["          "; 2]);
    ...
    fn assert_buffer_panics() {
        let backend = TestBackend::new(10, 2);
        let buffer = Buffer::with_lines(["aaaaaaaaaa"; 2]);
        backend.assert_buffer(&buffer);
    }
    ...
    fn draw() {
        ...
        backend
            .buffer()
            .assert_eq(&Buffer::with_lines(["a         "; 2]));
    }
